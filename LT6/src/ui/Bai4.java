...
public class Bai4 extends javax.swing.JFrame {
    ...
    DefaultComboBoxModel<HocSinhCB> model;
    public Bai4() {
        initComponents();
        setLocationRelativeTo(null);       
        //lấy lại model của combox => model quản lý dữ liệu của combox
        model = (DefaultComboBoxModel)cboMaHS.getModel();
...
//            JOptionPane.showMessageDialog(this, "Kết nối thành công");
    ...
    private void cboMaHSItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cboMaHSItemStateChanged
        try {
            HocSinhCB hs=(HocSinhCB) cboMaHS.getSelectedItem();
            String tenhs= hs.getTenHS();
    ...
    private void loadDataToComboBox() {
        try {
            ...
            while(rs.next()){                
                ...
                model.addElement(new HocSinhCB(mahs, tenhs));
            }
            rs.close();
            stm.close();
        } catch (Exception e) {
